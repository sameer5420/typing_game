document.addEventListener("DOMContentLoaded", () => {
    ...
    //Text to display
    const sampleTexts = ["In the end we only regret the chances we did not take", "Change is the only constant in life embrace it with open arms", "Happiness often sneaks in through a door you did not know you left open", "Dream big, work hard, and stay humble in all that you do"];
    //initial values
    let currentIndex = 0;
